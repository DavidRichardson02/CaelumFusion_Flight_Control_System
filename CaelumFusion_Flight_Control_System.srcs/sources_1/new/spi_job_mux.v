...
// spi_job_mux
//------------------------------------------------------------------------------
// One-hot mux / demux between multiple job FSMs and one shared SPI engine.
//
// CONTRACT
...
module spi_job_mux (
    ...
    output reg  [1:0]  e_cmd_cs_sel,
    output reg         e_cmd_3wire,
